...
import { UserIcon, CalendarIcon, ShieldIcon, MailIcon, BadgeIcon, EditIcon } from "@/components/icons";
    ...
    <div style={{ minHeight: "100vh", padding: "40px 24px" }}>
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 32, display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <div>
            <h1 style={{ fontSize: 32, fontWeight: 700, margin: 0, letterSpacing: "-0.02em" }}>My Profile</h1>
            <p style={{ fontSize: 16, color: "var(--text-secondary)", marginTop: 4 }}>Manage and view your account information</p>
          </div>
          <button 
